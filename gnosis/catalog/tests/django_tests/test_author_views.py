...
class PersonViewsTestCase(TestCase):
    ...
    def test_person_update(self):
        ...
        person = Person.objects.get(name='Fiona Anne Elliott')
        ...
        # to the login page.
        target_url = f"/admin/login/?next=/catalog/author/{person.id}/update/"
    ...
    def test_person_delete(self):
        ...
        response = self.client.get(reverse("person_delete", kwargs={'id': person.id}))
        target_url = f"/admin/login/?next=/catalog/author/{person.id}/delete/"
        # You have to be logged in to access the delete view.
        ...
        response = self.client.get(reverse("person_delete", kwargs={'id': person.id}))
        # Calling delete redirects to the authors index page
        target_url = f"/catalog/authors/"
        self.assertRedirects(response,
                             expected_url=target_url,
                             status_code=302,
                             target_status_code=200,)
    ...
    def test_person_create(self):
        ...
        target_url = "/accounts/login/?next=/catalog/author/create/"
        ...
        # Login the test user
        target_url = "/admin/login/?next=/catalog/author/create/"
