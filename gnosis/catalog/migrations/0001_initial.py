...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('error_field', models.CharField(choices=[('title', 'Title'), ('abstract', 'Abstract'), ('authors', 'Authors'), ('download', 'Download link'), ('venue', 'Venue')], max_length=20)),
                ('description', models.TextField(blank=True)),
                ('created_at', models.DateField(auto_now_add=True)),
                ('made_for', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedback', to='catalog.Paper')),
                ('proposed_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='paper_feedback', to=settings.AUTH_USER_MODEL)),
            ],
            options={
