# Generated by Django 2.2.5 on 2020-01-28 22:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('error_type', models.CharField(choices=[('Title', 'title'), ('Abstract', 'abstract'), ('Authors', 'authors'), ('Download link', 'download'), ('Venue', 'venue')], max_length=20)),
